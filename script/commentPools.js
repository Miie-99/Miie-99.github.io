...
const CommentPools = {
    ...
    replies: {
        ...
        toPraise: [
            ...
            { text: '真的真的！', lang: 'zh', type: 'agree' },
            { text: '说得太对了', lang: 'zh', type: 'agree' },
            { text: '我举双手双脚赞同', lang: 'zh', type: 'agree' },
            { text: '这话我爱听', lang: 'zh', type: 'agree' },
            { text: '还有那个XX也很绝', lang: 'zh', type: 'expand' },
            { text: '你们看到那个细节了吗', lang: 'zh', type: 'expand' },
            { text: '对对对还有那个表情！', lang: 'zh', type: 'expand' },
            { text: '补充一下，那段剧情也很神', lang: 'zh', type: 'expand' },
            { text: '不止这个，后面那段更绝', lang: 'zh', type: 'expand' },
            { text: '酸了酸了', lang: 'zh', type: 'jealous' },
            { text: '救命我酸成柠檬精了', lang: 'zh', type: 'jealous' },
            { text: '羡慕会画画的人', lang: 'zh', type: 'jealous' },
            { text: '为什么别人这么厉害', lang: 'zh', type: 'jealous' },
            { text: '柠檬.jpg', lang: 'zh', type: 'jealous' },
            { text: '接太太的才华！', lang: 'zh', type: 'agree' },
            { text: '说出了我的心声', lang: 'zh', type: 'agree' },
            { text: 'same here', lang: 'en', type: 'agree' },
            { text: 'ikr!!', lang: 'en', type: 'agree' },
            { text: 'this!!!', lang: 'en', type: 'agree' },
            { text: 'couldn\'t agree more', lang: 'en', type: 'agree' },
            { text: 'literally me', lang: 'en', type: 'agree' },
            { text: 'それな！', lang: 'jp', type: 'agree' },
            { text: '本当にそう', lang: 'jp', type: 'agree' },
            { text: 'わかる', lang: 'jp', type: 'agree' },
            { text: '激しく同意', lang: 'jp', type: 'agree' }
        ],
        ...
        toExcited: [
            ...
            { text: '我懂我懂！', lang: 'zh', type: 'join' },
            { text: '姐妹我也是！！', lang: 'zh', type: 'join' },
            { text: '一起原地去世', lang: 'zh', type: 'join' },
            { text: '让我加入！', lang: 'zh', type: 'join' },
            { text: '我也磕疯了', lang: 'zh', type: 'join' },
            { text: '姐妹冷静点（虽然我也不冷静', lang: 'zh', type: 'tease' },
            { text: '楼主还好吗哈哈哈', lang: 'zh', type: 'tease' },
            { text: '氧气瓶递给你', lang: 'zh', type: 'tease' },
            { text: '你需要冷静一下www', lang: 'zh', type: 'tease' },
            { text: '医院床位帮你预约了', lang: 'zh', type: 'tease' },
            { text: '120已经在路上了', lang: 'zh', type: 'tease' },
            { text: '喝杯水冷静一下', lang: 'zh', type: 'tease' },
            { text: '别激动别激动www', lang: 'zh', type: 'tease' },
            { text: '楼主你还活着吗', lang: 'zh', type: 'tease' },
            { text: '接楼主的激动！', lang: 'zh', type: 'join' },
            { text: '我也被硬控了', lang: 'zh', type: 'join' },
            { text: 'SAME OMG', lang: 'en', type: 'join' },
            { text: 'RIP us', lang: 'en', type: 'join' },
            { text: 'ME TOO', lang: 'en', type: 'join' },
            { text: 'let me join', lang: 'en', type: 'join' },
            { text: 'we\'re all dying together', lang: 'en', type: 'join' },
            { text: '分かる😭', lang: 'jp', type: 'join' },
            { text: '同じく死んだ', lang: 'jp', type: 'join' },
            { text: '無理無理', lang: 'jp', type: 'join' }
        ],

        // 回复阴阳类主楼
        toSarcasm: [
            { text: '阴阳人能不能闭嘴', lang: 'zh', type: 'defend' },
            { text: '有些人真的很烦', lang: 'zh', type: 'defend' },
            { text: '不喜欢可以不看啊', lang: 'zh', type: 'defend' },
            { text: '建议离开这个圈子', lang: 'zh', type: 'defend' },
            { text: '拉黑了谢谢', lang: 'zh', type: 'defend' },
            { text: '你说的对，你最厉害', lang: 'zh', type: 'sarcasm_back' },
            { text: '哦哦哦是是是', lang: 'zh', type: 'sarcasm_back' },
            { text: '好好好你说得都对', lang: 'zh', type: 'sarcasm_back' },
            { text: '典', lang: 'zh', type: 'sarcasm_back' },
            { text: '绷不住了', lang: 'zh', type: 'sarcasm_back' },
            { text: '大家冷静一下...', lang: 'zh', type: 'mediate' },
            { text: '算了懒得吵', lang: 'zh', type: 'mediate' },
            { text: '别吵了别吵了', lang: 'zh', type: 'mediate' },
            { text: '和平和平', lang: 'zh', type: 'mediate' },
            { text: '又开始了是吧', lang: 'zh', type: 'tired' },
            { text: '吃瓜.jpg', lang: 'zh', type: 'watch' },
            { text: '坐等后续', lang: 'zh', type: 'watch' },
            { text: '瓜田里的我', lang: 'zh', type: 'watch' },
            { text: '这瓜真甜', lang: 'zh', type: 'watch' },
            { text: '前排搬板凳', lang: 'zh', type: 'watch' },
            { text: '来了来了，最爱看撕逼', lang: 'zh', type: 'watch' },
            { text: 'popcorn ready', lang: 'en', type: 'watch' },
            { text: 'here we go again', lang: 'en', type: 'tired' }
        ],

        // 回复提问类主楼
        toQuestion: [
            { text: '这个梗是指...（解释）', lang: 'zh', type: 'answer' },
            { text: '我来科普：其实是...', lang: 'zh', type: 'answer' },
            { text: '简单来说就是...', lang: 'zh', type: 'answer' },
            { text: '这个我知道！是因为...', lang: 'zh', type: 'answer' },
            { text: '答案是这样的...', lang: 'zh', type: 'answer' },
            { text: '我也想知道！蹲一个', lang: 'zh', type: 'wait' },
            { text: '同问！等大佬解答', lang: 'zh', type: 'wait' },
            { text: '蹲一个答案', lang: 'zh', type: 'wait' },
            { text: '坐等科普', lang: 'zh', type: 'wait' },
            { text: '我也不懂，蹲', lang: 'zh', type: 'wait' },
            { text: '楼上说的对', lang: 'zh', type: 'confirm' },
            { text: '楼上正解', lang: 'zh', type: 'confirm' },
            { text: '楼上说得没错', lang: 'zh', type: 'confirm' },
            { text: '建议去看看原作', lang: 'zh', type: 'redirect' },
            { text: '可以搜一下梗百科', lang: 'zh', type: 'redirect' },
            { text: '这个B站有视频讲解', lang: 'zh', type: 'redirect' },
            { text: 'Same question lol', lang: 'en', type: 'wait' },
            { text: 'also curious', lang: 'en', type: 'wait' },
            { text: 'basically it means...', lang: 'en', type: 'answer' },
            { text: '同じく知りたい', lang: 'jp', type: 'wait' }
        ],
        ...
        toShare: [
            ...
            { text: '世界线收束了', lang: 'zh', type: 'relate' },
            { text: '原来不止我一个人', lang: 'zh', type: 'relate' },
            { text: '我也有同样的感受！', lang: 'zh', type: 'relate' },
            { text: '这说的不就是我', lang: 'zh', type: 'relate' },
            { text: '同担握手！', lang: 'zh', type: 'relate' },
            { text: '抱抱楼主', lang: 'zh', type: 'encourage' },
            { text: '建议多产出（暗示）', lang: 'zh', type: 'encourage' },
            { text: '加油！期待更多', lang: 'zh', type: 'encourage' },
            { text: '楼主继续！', lang: 'zh', type: 'encourage' },
            { text: '支持你！', lang: 'zh', type: 'encourage' },
            { text: '冲冲冲！', lang: 'zh', type: 'encourage' },
            { text: '这故事好棒', lang: 'zh', type: 'encourage' },
            { text: '感动了呜呜', lang: 'zh', type: 'encourage' },
            { text: 'relatable af', lang: 'en', type: 'relate' },
            { text: 'same bestie', lang: 'en', type: 'relate' },
            { text: 'literally me', lang: 'en', type: 'relate' },
            { text: 'felt that', lang: 'en', type: 'relate' },
            { text: 'we\'re the same person', lang: 'en', type: 'relate' },
            { text: 'keep going!', lang: 'en', type: 'encourage' },
            { text: '私も！', lang: 'jp', type: 'relate' },
            { text: '同じです', lang: 'jp', type: 'relate' }
        ],
        ...
        toMeme: [
            ...
            { text: '笑到头掉', lang: 'zh', type: 'laugh' },
            { text: '笑出腹肌了', lang: 'zh', type: 'laugh' },
            { text: '笑死我了救命', lang: 'zh', type: 'laugh' },
            { text: '这什么鬼哈哈哈', lang: 'zh', type: 'laugh' },
            { text: '绷不住了www', lang: 'zh', type: 'laugh' },
            { text: '太草了', lang: 'zh', type: 'laugh' },
            { text: '懂的都懂', lang: 'zh', type: 'get_it' },
            { text: '会心一笑', lang: 'zh', type: 'get_it' },
            { text: '这梗我懂', lang: 'zh', type: 'get_it' },
            { text: '老懂哥了', lang: 'zh', type: 'get_it' },
            { text: '这个必须顶', lang: 'zh', type: 'support' },
            { text: '太对了', lang: 'zh', type: 'support' },
            { text: '真实', lang: 'zh', type: 'support' },
            { text: '确实', lang: 'zh', type: 'support' },
            { text: '实在太真实了', lang: 'zh', type: 'support' },
            { text: '就是这样的！', lang: 'zh', type: 'support' },
            { text: '接！', lang: 'zh', type: 'support' },
            { text: '这也太city了', lang: 'zh', type: 'support' },
            { text: '不愧是你', lang: 'zh', type: 'support' },
            { text: 'lmaooo', lang: 'en', type: 'laugh' },
            { text: 'LMFAO', lang: 'en', type: 'laugh' },
            { text: 'I can\'t 💀', lang: 'en', type: 'laugh' },
            { text: 'crying rn', lang: 'en', type: 'laugh' },
            { text: 'so real', lang: 'en', type: 'support' },
            { text: '草', lang: 'jp', type: 'laugh' },
            { text: 'ワロタ', lang: 'jp', type: 'laugh' },
            { text: 'それな', lang: 'jp', type: 'support' }
        ]
    },
