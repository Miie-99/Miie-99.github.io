...
const DATA = {
    ...
    events: {
        ...
        consume: [
            ...
            { title: "官方发糖", text: "最新一集动画里他们牵手了。", effect: { love: 15, san: 5 } },
            ...
            { title: "体格差神图", text: "刷到一张神图，身材高大的1单手抱起娇小的0，0的双腿紧紧盘在1腰间，这个体型差让你瞬间嘶哈。", effect: { love: 30, passion: 20 } },
        ...
        social: [
            ...
            { title: "only展", text: "去参加了Only漫展，现场氛围好到爆炸，没有乱七八糟的人员，大家都在疯狂贴贴，你买本子买得停不下来。", effect: { social: 30, money: -500, passion: 20 } },
            { title: "一眼顶针", text: "群里混进了一个对家视奸号，发言没破绽，但从qq标签被你一眼识破。你带头把他挂了出来，群友纷纷称赞你火眼金睛，守护了这一方净土。", effect: { social: 15, combat: 20, san: 5 } },
